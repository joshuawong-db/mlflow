...
export const ToolCallStatistics: React.FC = () => {
  ...
  return (
    <div>
      <Typography.Text size="md" bold color="secondary" css={{ display: 'block', marginBottom: theme.spacing.sm }}>
        <FormattedMessage defaultMessage="Tools" description="Section header above the tool statistics callouts" />
      </Typography.Text>
      <div
        css={{
          display: 'flex',
